...
class DamiiSession extends GameSession {
  ...
  _expireHukura() {
    ...
    this._completeTurn(this.state.lastMove, this.state.lastMove?.from, this.state.lastMove?.to);
  }

  _completeTurn(move, from, to, hukuraCalled = false) {
