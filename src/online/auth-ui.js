/**
 * Google Sign-In overlay using Firebase Auth.
 */
 ...
 * @param {function} callbacks.onSignedIn - Called with player data after sign-in
...
export function createAuthUI(container, callbacks) {
  ...
  async function handleGoogleSignIn() {
    ...
    try {
      ...
      saveSession(data.sessionToken, data.player);

      hide();
      callbacks.onSignedIn(data.player);
    } catch (err) {
